...
import com.example.andresfelipe.pokegame.Pokefight.Fight;
import com.example.andresfelipe.pokegame.R;
import com.example.andresfelipe.pokegame.Singleton.MySingleton;
        ...
        Selection.setOnClickListener (new View.OnClickListener(){
            ...
            fight.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("experiencia1", vida1);
                    intent.putExtra("experiencia2", vida2);
        ...
        JsonObjectRequest jsonObjRequest= new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    name1=pokeone.Getname().toString();
                    vida1=pokeone.Getvida();
                    imagen1=pokeone.Getimagen().toString();
        ...
        JsonObjectRequest jsonObjRequest= new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    //Asignando a valores globales

                    name2=poketwo.Getname().toString();
                    vida2=poketwo.Getvida();
                    imagen2=poketwo.Getimagen().toString();
